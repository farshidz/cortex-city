...
export interface OrchestratorConfig {
  ...
  /** Authors exempt from the weekly usage limit. GitHub logins are case-insensitive. */
  review_author_whitelist?: string[];
  /** Unset disables the gate; 0–100 applies to authors outside the exemption list. */
