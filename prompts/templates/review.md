...
9. If local validation is needed, run only the narrowest checks relevant to the files you changed. Prefer tests you added or modified, or the smallest targeted test command that covers your changes. Do not run the full local test suite unless it is absolutely required.
