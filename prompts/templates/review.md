...
2. Review every open inline comment, PR-level comment, and submitted review above so you understand the requested changes. Ignore threads that are already resolved on GitHub.
