...
5. Push the branch and create a pull request targeting `{{BASE_BRANCH}}` with a clear title and description
...
9. Use the Follow-up Task Requests and Available Agents sections below when you need to request additional follow-up work. If a follow-up task is needed, include it in your final JSON response under `tool_calls.create_task`; otherwise omit `tool_calls`.
