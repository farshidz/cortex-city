...
9. Do not reformat code you are not changing. Keep the diff tightly scoped so review stays readable. Fix CI failures related to or caused by this PR. Report unrelated failures in your final summary without fixing them or creating subtasks for them.
