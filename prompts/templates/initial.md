...
8. Use the Available Tools and Available Agents sections below when you need to request additional follow-up work, and omit `tool_calls` entirely if no tools are required.
