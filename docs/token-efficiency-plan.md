...
| Stop reprocessing already-handled conversation | [PR #121 merged](https://github.com/farshidz/cortex-city/pull/121) | The timestamp-based record of seen conversation causes repeat reply rounds. Evidence and proposed direction are below. Preserve comments that arrive during a run but were not handled. |
